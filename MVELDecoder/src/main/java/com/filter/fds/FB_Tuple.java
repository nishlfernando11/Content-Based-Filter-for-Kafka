...
public final class FB_Tuple extends Table {
  ...
  public ByteBuffer kAsByteBuffer() {
  ...
  public ByteBuffer vAsByteBuffer() {
      return __vector_as_bytebuffer(6, 1);
  }

  public static int createFB_Tuple(FlatBufferBuilder builder, int k, int v) {
  ...
  public static void startFB_Tuple(FlatBufferBuilder builder) {
      builder.startObject(2);
  }
  public static void addK(FlatBufferBuilder builder, int kOffset) {
      builder.addOffset(0, kOffset, 0);
  }
  public static void addV(FlatBufferBuilder builder, int vOffset) {
      builder.addOffset(1, vOffset, 0);
  }
