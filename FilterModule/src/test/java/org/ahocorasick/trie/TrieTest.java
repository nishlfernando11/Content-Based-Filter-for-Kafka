...
public class TrieTest {
    ...
    public void ushersTestByCallback() {
        ...
        EmitHandler emitHandler = new EmitHandler() {
            ...
            public void emitNoneDuplicate(Emit emit) {
                if(!emits.contains(emit))
                    emits.add(emit);
                else
                    System.out.println("Duplicate found "+ emit);
            }
        };
    ...
    @Test
    public void parseTextforAndPass(){
        // Assign
        ...
        actual = trie.parseTextforAnd(message);
    ...
    @Test
    public void parseTextforAndFail(){
        // Assign
        String message  = "America is good with China. Reported a good news";
        ArrayList<String> interests = new ArrayList<String>();
        interests.add("america");
