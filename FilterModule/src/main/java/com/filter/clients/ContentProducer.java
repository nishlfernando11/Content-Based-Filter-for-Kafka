...
import com.filter.clients.Interfaces.IContentProducer;
 ...
 */
public class ContentProducer implements IContentProducer {
    ...
    public ContentProducer(String topic){
        this.setTopic(topic);
    }
    ...
    public static void main(String args[]){
        ...
        ContentProducer producer = new ContentProducer(topicName);
